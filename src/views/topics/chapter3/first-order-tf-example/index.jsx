...
const stepResponse = (k, a) =>
    "$$\\begin{cases}G(s) = " +
    TransferFunction.$1nd(k, -a).toString() +
    (a !== 0
        ? " \\\\ \\\\ c(t) = " +
            ...
            <Grid sx={{ margin: "auto", width: "100%" }} item>
                <SubCard sx={{ direction: "ltr" }}>
                    ...
                    >
                        ...
                        {!isGraphCatured && (
                            <Grid style={{ fontSize: "18px" }} md={6} sm={12}>
            ...
            >
                ...
                <Grid md={9} sm={12} xs={12} item>
                    ...
                    <Grid lg={12} md={12} sm={12} xs={12} item>
                        <SubCard>
                            <GraphBox title="Step/ramp response" traces={traces} />
                        </SubCard>
                    </Grid>
                </Grid>
            </Grid>
...
export default FirstOrderTfExample;
