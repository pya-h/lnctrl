    ...
    return (
        ...
        >
            <Grid className="lecture-text" item>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp; تاخیر مدت زمانی است که باید طی شود تا خروجی به ورودی پاسخ دهد.
                </p>
            </Grid>
            <Grid className="lecture-text" item>
                <p>
            ...
            <Grid className="lecture-text" item>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp; تاخیر خالص در اندازه تاثیر نمی گذارد بلکه فقط زاویه فاز را به طور خطی با فرکانس تغییر می دهد.
                </p>
            </Grid>
            <Grid item>
