        ...
        <Grid container>
            ...
            <Grid xs={12} item>
                ...
                >
                    ...
                    نمودار نایکوئیست را می‌توان با استفاده از چهار نقطه مهم زیر
                    رسم کرد:
                </Typography>
            </Grid>
            <Grid xs={12} sx={{ m: "auto" }} item>
            ...
            <Grid xs={12} item>
                ...
                >
                    ...
                    <h3>3) تعیین نقاط احتمالی قطع محورهای حقیقی</h3>
                    برای به دست آوردن نقاط احتمالی قطع محورهای حقیقی، زاویه فاز
                    را برابر 0 یا &nbsp;
                    <MathJax inline={true} style={{ fontSize: "18px" }}>
                        {`\\( \\pm 180 \\)`}
                    </MathJax>
                    &nbsp; درجه قرار داده یا قسمت موهومی را برابر صفر قرار
                    می‌دهیم.
                    <MathJax style={{ fontSize: "18px" }}>
                    ...
                    <h3>4) تعیین نقاط احتمالی قطع محورهای موهومی</h3>
                    برای به دست آوردن نقاط احتمالی قطع محورهای موهومی، زاویه فاز
                    را برابر &nbsp;
                    <MathJax inline={true} style={{ fontSize: "18px" }}>
                        {`\\( \\pm 90 \\)`}
                    </MathJax>
                    &nbsp;درجه قرار داده یا قسمت حقیقی را برابر صفر قرار
                    می‌دهیم.
                    <MathJax style={{ fontSize: "18px" }}>
                        {`$$ G(j\\omega) = |G(j\\omega) \\angle G(j\\omega) = R(\\omega) + jX(\\omega) \\\\
                                \\Rightarrow R(\\omega) = 0, \\quad \\angle G(j\\omega) = \\pm 90 $$`}
                    </MathJax>
                    <h3> نمودارهای نایکوئیست سیستم های نوع صفر، یک و دو </h3>
                    1) نمودار نایکوئیست سیستم نوع صفر مثل: &nbsp;
                    <MathJax style={{ fontSize: "18px" }}>
                        {`$$ G(s) = \\frac{1}{1 + sT} $$`}
                    </MathJax>
                    <br />
                    2) نمودار نایکوئیست سیستم نوع یک مثل: &nbsp;
                    <MathJax style={{ fontSize: "18px" }}>
                        {`$$ G(s) = \\frac{1}{s(1 + sT)} $$`}
                    </MathJax>
                    <br />
                    3) نمودار نایکوئیست سیستم نوع دو مثل: &nbsp;
                    <MathJax style={{ fontSize: "18px" }}>
                        {`$$ G(s) = \\frac{1}{s^2(1 + sT)} $$`}
                    </MathJax>
                    <br />
