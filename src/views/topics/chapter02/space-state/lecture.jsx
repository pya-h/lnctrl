        ...
        >
            <Typography>
                <Grid className="lecture-text" item>
                    <p>
                        &nbsp; &nbsp; &nbsp; &nbsp; معادلات حالت وخروجی زیر را
                        در نظر بگیرید:
                    </p>
                    <MathJax>{formulaSpaceStateEquations}</MathJax>
                    <p>
                        &nbsp; &nbsp; &nbsp; &nbsp; اگر معادله اول را به ازای یک
                        ورودی معین و شرایط اولیه داده شده حل کنیم پاسخ متغیرهای
                        حالت سیستم را را به ورودی اعمال شده به سیستم بدست می
                        آوریم. با جایگزینی بردار حالت محاسبه شده x(t) در رابطه ی
                        خروجی y(t) پاسخ سیستم را به ازای همان ورودی و شرایط
                        اولیه بدست آورده ایم.
                    </p>
                    <p>
                ...
                <Grid className="lecture-text" item>
                    <p>
                        &nbsp; &nbsp; &nbsp; &nbsp; حال اگر این نتیجه را با
                        رابطه ی به دست آمده از روش مستقیم مقایسه کنیم:
                    </p>
