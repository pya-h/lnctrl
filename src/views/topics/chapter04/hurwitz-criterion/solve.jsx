...
const determine = (Deltas, a_i) => {
    ...
    if (a_i.length > 0 && Deltas.length > 0) {
        ...
        if (i >= Deltas.length) {
            properties.push(
                "All poles of the system are to the left of the imaginary axis and the system is stable."
            );
            return properties;
        }
        ...
        for (i = 0; i < a_i.length; i++) {
            if (a_i[i] === 0) {
                properties.push(
                    "there is a root on the right side or on the imaginary axis."
                );
                return properties;
            }
        }
        ...
        for (i = 0; i < a_i.length; i++) {
            ...
            if (a_i[i] * a_i[0] < 0) {
                properties.push("There is a root on the right of the imaginary axis.");
                return properties;
            }
        }
    }
